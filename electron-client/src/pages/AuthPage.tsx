...
import { FontAwesomeIcon, faEye, faEyeSlash, faLock, faRightFromBracket, faSpinner, faUserOutline } from '@/icons'
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            <div className="relative">
              ...
              <input
                ...
                placeholder="Логин"
                className="w-full pl-10 pr-4 py-3 border border-slate-600 rounded-lg bg-slate-700 text-white placeholder-slate-400 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none"
                required
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Пароль"
                className="w-full pl-10 pr-12 py-3 border border-slate-600 rounded-lg bg-slate-700 text-white placeholder-slate-400 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none"
                required
            ...
            >
              <FontAwesomeIcon icon={isLoading ? faSpinner : faRightFromBracket} spin={isLoading} />
